            ...
            <div className="p-2">
                <div className="bg-white w-full rounded-xl border flex flex-col">
                    <div className="flex flex-col gap-4 border-b p-4">
                        ...
                        <div>
                            <label htmlFor="inputSearch" className="border w-fit rounded-md flex gap-2 items-center px-2 py-2">
                            ...
                            filterdData.length >= 1 ? filterdData.map((item, index) => (
                                <div key={index} className={`flex flex-col p-4 gap-3 hover:bg-gray-100 ${index !== filterdData.length - 1 ? 'border-b' : ''}`}>
                                    <div className="flex gap-2 items-center">
                                        ...
                                        <span className="bg-[#EFF8FF] border border-[#B2DDFF] text-primary text-xs px-2 rounded-full">{item.type}</span>
                                    </div>
